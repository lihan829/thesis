...
Autosegmental theory marks a shift away from the linear representations
...
\citep{elimelech1976tonal}. Unlike in Engenni, the tone T1 originally
...
\subsection{Contour tones}
\subsection{Tone spreading}
\subsection{Floating tones}
\subsection{Domain-level association in Shanghai}

\section{Computational Approaches to Tone}
  \subsection{String-Based Approaches}
  \subsection{Finite-State Approaches}
  \subsection{Computational Models of Autosegmental Structure}
  \subsection{Representation and Learnability}